...
3. Asegúrate de que los tests pasen: `forge test`
4. Formatea el código: `forge fmt`
5. Haz push y crea un Pull Request

## Notas Importantes

- **Nunca** hagas commit de archivos en `cache/` o `out/` - están en `.gitignore`
- Los submódulos deben estar inicializados antes de compilar
- Usa `forge fmt` antes de hacer commit para mantener el código formateado
- Siempre ejecuta los tests antes de hacer push: `forge test`
